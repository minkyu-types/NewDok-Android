...
@Composable
fun BookmarkSortFilterBottomSheet(
    title: String,
    sheetState: SheetState,
    prevSort: ArticleSortCategory?,
    onDismiss: (ArticleSortCategory) -> Unit,
    onHideRequested: () -> Unit,
    modifier: Modifier = Modifier
) {
    var selectedSort by remember {
        mutableStateOf(
            prevSort ?: ArticleSortCategory.SORT_RECENT_ADDED
        )
    }
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            ArticleSortCategory.entries.forEach { category ->
                BookmarkSortItem(
                    sort = category,
...
@Composable
private fun BookmarkSortItem(
    sort: ArticleSortCategory,
    isSelected: Boolean,
    onClick: (ArticleSortCategory) -> Unit,
    modifier: Modifier = Modifier
) {
    Box(
        modifier = modifier
...
private fun AllNewsLettersFilterBottomSheetPreview() {
    DefaultWhiteTheme {
        BookmarkSortItem(
            sort = ArticleSortCategory.SORT_RECENT_ADDED,
            isSelected = false,
            onClick = {
